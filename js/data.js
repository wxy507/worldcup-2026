...
const WorldCupData = {
  ...
  groups: [
    {id:"A",name:"A组",teams:["MEX","GER","MAR","PAR"]},
    {id:"B",name:"B组",teams:["BRA","KOR","SEN","NZL"]},
    {id:"C",name:"C组",teams:["ARG","IRN","NGA","CRO"]},
    {id:"D",name:"D组",teams:["FRA","AUS","PER","DEN"]},
    {id:"E",name:"E组",teams:["ENG","USA","TUN","UKR"]},
    {id:"F",name:"F组",teams:["ESP","JPN","CMR","SUI"]},
    {id:"G",name:"G组",teams:["POR","COL","EGY","SVK"]},
    {id:"H",name:"H组",teams:["NED","URU","ALG","IRQ"]},
    {id:"I",name:"I组",teams:["ITA","CRC","GHA","POL"]},
    {id:"J",name:"J组",teams:["BEL","KSA","ECU","HUN"]},
    {id:"K",name:"K组",teams:["CAN","CIV","SRB","QAT"]},
    {id:"L",name:"L组",teams:["NOR","CHI","SWE","WAL"]},
  ],
  teams: {
    MEX:{code:"MX",name:"墨西哥",fifaRank:12,region:"CONCACAF",coach:"哈梅·洛萨诺",stadium:"阿兹特克体育场"},
    GER:{code:"DE",name:"德国",fifaRank:3,region:"UEFA",coach:"朱利安·纳格尔斯曼",stadium:"安联竞技场"},
    MAR:{code:"MA",name:"摩洛哥",fifaRank:13,region:"CAF",coach:"瓦利德·雷格拉吉",stadium:"穆罕默德五世体育场"},
    PAR:{code:"PY",name:"巴拉圭",fifaRank:42,region:"CONMEBOL",coach:"吉列尔莫·巴罗斯·谢洛托",stadium:"查科保卫者体育场"},
    NOR:{code:"NO",name:"挪威",fifaRank:36,region:"UEFA",coach:"斯塔莱·索尔巴肯",stadium:"乌勒瓦尔体育场"},
    BRA:{code:"BR",name:"巴西",fifaRank:1,region:"CONMEBOL",coach:"多里瓦尔·儒尼奥尔",stadium:"马拉卡纳体育场"},
    KOR:{code:"KR",name:"韩国",fifaRank:28,region:"AFC",coach:"黄善洪",stadium:"首尔世界杯体育场"},
    SEN:{code:"SN",name:"塞内加尔",fifaRank:20,region:"CAF",coach:"阿利乌·西塞",stadium:"迪亚姆尼亚迪奥体育场"},
    NZL:{code:"NZ",name:"新西兰",fifaRank:104,region:"OFC",coach:"达伦·巴泽利",stadium:"伊甸园体育场"},
    ARG:{code:"AR",name:"阿根廷",fifaRank:2,region:"CONMEBOL",coach:"莱昂内尔·斯卡洛尼",stadium:"纪念碑体育场"},
    IRN:{code:"IR",name:"伊朗",fifaRank:22,region:"AFC",coach:"阿米尔·加莱诺伊",stadium:"阿扎迪体育场"},
    NGA:{code:"NG",name:"尼日利亚",fifaRank:38,region:"CAF",coach:"何塞·佩塞罗",stadium:"阿布贾国家体育场"},
    CRO:{code:"HR",name:"克罗地亚",fifaRank:7,region:"UEFA",coach:"兹拉特科·达利奇",stadium:"马克西米尔体育场"},
    FRA:{code:"FR",name:"法国",fifaRank:4,region:"UEFA",coach:"迪迪埃·德尚",stadium:"法兰西体育场"},
    AUS:{code:"AU",name:"澳大利亚",fifaRank:27,region:"AFC",coach:"格拉汉姆·阿诺德",stadium:"悉尼奥林匹克体育场"},
    PER:{code:"PE",name:"秘鲁",fifaRank:30,region:"CONMEBOL",coach:"豪尔赫·福萨蒂",stadium:"国家体育场（利马）"},
    DEN:{code:"DK",name:"丹麦",fifaRank:10,region:"UEFA",coach:"卡斯珀·尤尔曼德",stadium:"公园体育场"},
    ENG:{code:"GB-ENG",name:"英格兰",fifaRank:5,region:"UEFA",coach:"加雷斯·索斯盖特",stadium:"温布利体育场"},
    USA:{code:"US",name:"美国",fifaRank:11,region:"CONCACAF",coach:"格雷格·贝尔哈特",stadium:"大都会体育场"},
    TUN:{code:"TN",name:"突尼斯",fifaRank:31,region:"CAF",coach:"杰拉尔丁·凯西",stadium:"拉迪斯奥林匹克体育场"},
    UKR:{code:"UA",name:"乌克兰",fifaRank:25,region:"UEFA",coach:"谢尔盖·雷布罗夫",stadium:"奥林匹克体育场（基辅）"},
    ESP:{code:"ES",name:"西班牙",fifaRank:6,region:"UEFA",coach:"路易斯·德拉富恩特",stadium:"圣地亚哥伯纳乌体育场"},
    JPN:{code:"JP",name:"日本",fifaRank:17,region:"AFC",coach:"森保一",stadium:"国立竞技场"},
    CMR:{code:"CM",name:"喀麦隆",fifaRank:44,region:"CAF",coach:"里戈伯特·宋",stadium:"奥姆尼体育场"},
    SUI:{code:"CH",name:"瑞士",fifaRank:15,region:"UEFA",coach:"穆拉特·雅金",stadium:"圣雅各布公园球场"},
    POR:{code:"PT",name:"葡萄牙",fifaRank:8,region:"UEFA",coach:"罗伯托·马丁内斯",stadium:"光明体育场"},
    COL:{code:"CO",name:"哥伦比亚",fifaRank:14,region:"CONMEBOL",coach:"内斯托尔·洛伦佐",stadium:"大都会体育场（巴兰基亚）"},
    EGY:{code:"EG",name:"埃及",fifaRank:35,region:"CAF",coach:"鲁伊·维多利亚",stadium:"开罗国际体育场"},
    SVK:{code:"SK",name:"斯洛伐克",fifaRank:45,region:"UEFA",coach:"弗兰切斯科·卡尔佐纳",stadium:"塔特拉体育场"},
    NED:{code:"NL",name:"荷兰",fifaRank:9,region:"UEFA",coach:"罗纳德·科曼",stadium:"约翰·克鲁伊夫竞技场"},
    URU:{code:"UY",name:"乌拉圭",fifaRank:16,region:"CONMEBOL",coach:"马塞洛·贝尔萨",stadium:"百年纪念体育场"},
    ALG:{code:"DZ",name:"阿尔及利亚",fifaRank:34,region:"CAF",coach:"贾迈勒·贝尔马迪",stadium:"1962年7月5日体育场"},
    IRQ:{code:"IQ",name:"伊拉克",fifaRank:63,region:"AFC",coach:"赫苏斯·卡萨斯",stadium:"巴士拉国际体育场"},
    ITA:{code:"IT",name:"意大利",fifaRank:18,region:"UEFA",coach:"卢西亚诺·斯帕莱蒂",stadium:"罗马奥林匹克体育场"},
    CRC:{code:"CR",name:"哥斯达黎加",fifaRank:39,region:"CONCACAF",coach:"古斯塔沃·阿尔法罗",stadium:"国家体育场（圣何塞）"},
    GHA:{code:"GH",name:"加纳",fifaRank:40,region:"CAF",coach:"克里斯·休顿",stadium:"阿克拉体育场"},
    POL:{code:"PL",name:"波兰",fifaRank:23,region:"UEFA",coach:"米哈乌·普罗别日",stadium:"国家体育场（华沙）"},
    BEL:{code:"BE",name:"比利时",fifaRank:19,region:"UEFA",coach:"多梅尼科·特德斯科",stadium:"博杜安国王体育场"},
    KSA:{code:"SA",name:"沙特阿拉伯",fifaRank:53,region:"AFC",coach:"罗伯托·曼奇尼",stadium:"阿卜杜拉国王体育城"},
    ECU:{code:"EC",name:"厄瓜多尔",fifaRank:29,region:"CONMEBOL",coach:"菲利克斯·桑切斯",stadium:"罗德里戈·帕斯·德尔加多体育场"},
    HUN:{code:"HU",name:"匈牙利",fifaRank:32,region:"UEFA",coach:"马尔科·罗西",stadium:"普斯卡什竞技场"},
    CAN:{code:"CA",name:"加拿大",fifaRank:48,region:"CONCACAF",coach:"杰西·马什",stadium:"BMO体育场"},
    CIV:{code:"CI",name:"科特迪瓦",fifaRank:43,region:"CAF",coach:"埃默斯·法埃",stadium:"阿拉萨内·瓦塔拉体育场"},
    SRB:{code:"RS",name:"塞尔维亚",fifaRank:26,region:"UEFA",coach:"德拉甘·斯托伊科维奇",stadium:"红星体育场"},
    QAT:{code:"QA",name:"卡塔尔",fifaRank:58,region:"AFC",coach:"马尔克斯·洛佩斯",stadium:"卢赛尔体育场"},
    CHI:{code:"CL",name:"智利",fifaRank:37,region:"CONMEBOL",coach:"加雷卡",stadium:"国家体育场（圣地亚哥）"},
    SWE:{code:"SE",name:"瑞典",fifaRank:24,region:"UEFA",coach:"扬内·安德松",stadium:"朋友体育场"},
    WAL:{code:"GB-WLS",name:"威尔士",fifaRank:33,region:"UEFA",coach:"罗布·佩奇",stadium:"千禧体育场"},
  },
  squads: {
